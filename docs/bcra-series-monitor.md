...
Los identificadores históricos `128`, `129` y `131` no existen en el catálogo `v4.0`. Se mantienen en la configuración para que el monitor documente la incompatibilidad. No deben reemplazarse hasta validar la equivalencia económica y la unidad de medida de las series sustitutas.
